...
readonly C_PRIMARY='\033[1;34m'    # 蓝色 - 主色调
readonly C_SECONDARY='\033[1;36m'  # 青色 - 次要
readonly C_SUCCESS='\033[1;32m'    # 绿色 - 成功
readonly C_WARNING='\033[1;33m'    # 黄色 - 警告
readonly C_ERROR='\033[1;31m'      # 红色 - 错误
