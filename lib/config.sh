...
DATA_BASE="/mnt"
BACKUP_ROOT="/mnt/backup/rsnapshot"
MANUAL_BACKUP="$BACKUP_ROOT/manual"
DISABLED_USERS_FILE="$DATA_DIR/disabled_users.txt"
USER_CREATION_LOG="$DATA_DIR/created_users.txt"
USER_REPORT_DIR="$REPORT_DIR"
USER_PORT_MAP_FILE="$DATA_DIR/user_port_map.txt"
PASSWORD_POOL_FILE="$DATA_DIR/password_pool.txt"
USER_CONFIG_FILE="$DATA_DIR/user_config.json"
EMAIL_CONFIG_FILE="$DATA_DIR/email_config.json"
DNS_CONFIG_FILE="$DATA_DIR/dns_whitelist.txt"
JOB_STATS_DIR="$DATA_DIR/job_stats"
SYMLINK_LOG="$LOG_DIR/symlink.log"
PASSWORD_ROTATE_LOG="$LOG_DIR/password_rotate.log"
...
# === systemd 配置 ===
RESOURCE_LIMIT_FILENAME="90-user-manager-limits.conf"
...
# === Miniforge 配置 ===
MINIFORGE_INSTALLER="$SCRIPT_DIR/Miniforge.sh"
MINIFORGE_DEFAULT_PATH=".miniforge"
CONDARC_TEMPLATE="$DATA_DIR/condarc.template"
